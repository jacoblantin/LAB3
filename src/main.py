...
interface.py, to achieve the objectives of ME405 Lab03.
...
class CLPControl:
    ...
    def __init__(self):
        ...
        self.moe = MotorDriver()        

        # intialize encoder
        self.pin1 = pyb.Pin(pyb.Pin.board.PC6, pyb.Pin.IN)
        self.pin2 = pyb.Pin(pyb.Pin.board.PC7, pyb.Pin.IN)
